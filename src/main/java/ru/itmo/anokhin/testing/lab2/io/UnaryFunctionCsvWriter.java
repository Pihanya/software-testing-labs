...
import static ru.itmo.anokhin.testing.lab2.utils.IOConstants.UNARY_FUNCTION_WRITER_CSV_FORMAT;
...
public class UnaryFunctionCsvWriter {
  ...
  public void writeSeries(double startX, double endX, double xStep) {
    ...
    try {
      ...
      try (final CSVPrinter printer = new CSVPrinter(fileWriter, UNARY_FUNCTION_WRITER_CSV_FORMAT)) {
